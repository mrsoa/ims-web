    ...
    >
      <Form form={form}>
        <FormItem
          ...
          label="接口编码"
          name="serviceCode"
          rules={[{ required: true, message: '请输入至少三个字符的接口编码！', min: 3 }]}
        >
        ...
        <FormItem
          ...
          label="接口名称"
          name="serviceName"
          rules={[{ required: true, message: '请输入至少五个字符的接口名称！', min: 5 }]}
        >
          <Input placeholder="请输入" />
        </FormItem>
        <FormItem
        ...
        name="isRetOne"
         >
          <Checkbox value="1" >是否返回对象</Checkbox>
        </Form.Item>
        <FormItem
          labelCol={{ span: 5 }}
          wrapperCol={{ span: 18 }}
          label="脚本"
          name="sqlText"
          rules={[{ required: true, message: '请输入至少五个字符的脚本信息！', min: 5 }]}
        >
          <TextArea
            style={{ minHeight: 32 }}
            placeholder="请输入"
