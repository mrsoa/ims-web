...
const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/locales/en-US.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/pages/process/add/locales/en-US.ts')),
    },
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/locales/pt-BR.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/pages/process/add/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/locales/zh-CN.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/pages/process/add/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/locales/zh-TW.ts')),...((locale) => locale.__esModule ? locale.default : locale)(require('C:/DEV/Vscode/ims-web/src/pages/process/add/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
